...
(X_train, y_train), (X_test, y_test) = imdb.load_data(num_words=top_words, start_char=1, oov_char=2, index_from=3)
...
print(X_train_vectorized.shape[1:] ,X_train_padded.shape[1:])
exit()
...
#model_RNN = createNetwork('Sequence', 2, X_train_padded.shape[1:], num_classes, optimizer='rmsprop')
model_RNNx = createNetwork('Sequence', 3, X_train_padded.shape[1:], num_classes, optimizer='rmsprop')
